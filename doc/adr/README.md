...
Policy: Proposed ADRs may change. Accepted ADRs are immutable except by a later superseding ADR. A proposed phase ADR becomes Accepted only after its acceptance criteria are fulfilled.

* [1. Record architecture decisions](0001-record-architecture-decisions.md) — Accepted
* [2. Phase 1 Runner Seam for Hatchet Integration](0002-phase-1-runner-seam-for-hatchet-integration.md) — Accepted
